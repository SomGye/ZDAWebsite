...
const SectionIndicator = ({ sectionName }: props) => {
  return (
    <div className="long-fading-line-container flex flex-row justify-center lg:justify-start items-center w-full my-8">
