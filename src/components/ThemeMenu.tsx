      ...
      <div className="inline-flex items-center focus-visible:outline-none">
        <DropdownMenu.Root open={open}>
          ...
          <DropdownMenu.Portal>
            ...
            >
              <DropdownMenu.Item
                className="group pb-[1px] my-2 md:my-0 text-base 3xl:text-lg 4xl:text-2xl 4k:text-3xl lg:py-3 3xl:py-4 4xl:py-6 4k:py-8 lg:px-6 3xl:px-8 4xl:px-10 4k:px-12 leading-none text-zdaRedpink-600/90 dark:text-zdaRedpink-600 rounded-md 3xl:rounded-lg flex items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[highlighted]:bg-zdaRedpink-600/75 data-[highlighted]:text-neutral-50 dark:data-[highlighted]:bg-zdaRedpink-600/85 dark:data-[highlighted]:text-zinc-950"
